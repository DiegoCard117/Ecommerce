  ...
  const parcelas = Array.from({ length: 12 }, (_, index) => ({
    ...
    valor:
      index === 0
        ...
        : ((products.price * 1.2) / (index + 1)).toFixed(2),
  }));
              ...
              <div className="productDetails">
                ...
                >
                  {products.pictures.map((item) => (
                    <SwiperSlide className="slides" key={item.id}>
                      <Image
                        className="imgProductDetails"
                        src={item.url
                          .replace(/http2:/gi, "https:")
                ...
                <span className="priceRed">
                  R$ {(products.price * 1.2).toFixed(2)}
                </span>
                <p className="divisor">
                  em até 12x de R${" "}
                  <p className="spanRed">
                    {((products.price * 1.2) / 12).toFixed(2)}
                  </p>{" "}
                  sem juros no cartão
                </p>
                <button
                  ...
                  className="btnBuy"
                >
                  <Image src={addcart} alt="" width={30} height={30} />
                  <div>
                    ...
                    <div className="boxDivisor">
                      ...
                      <div>
                        {parcelas.map((parcela) => (
                          <p className="" key={parcela.numero}>
