        ...
        <div className="LoginRight">
          ...
          <div className="MedLogin">
            <form className="formLogin">
              ...
              <button className="btnLogin">Acessar Conta</button>
            </form>
            <div className="boxLoginSocial">
              {/* login com google */}
              <button className="socialLogin" onClick={login}>
          ...
          <div className="BottomLogin">
            <Link href={"/Recuperar"} className="LinkRecuperar">
              Esqueci minha senha
            </Link>
            <Link href="/Cadastro" className="LinkCadastro">
              <Image src={usuario} alt="" width={50} height={50} />
              <h2>Novo Cliente?</h2>
            </Link>
          </div>
        </div>
